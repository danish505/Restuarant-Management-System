...
for ($i = 0; $i < $data_lenght; $i++){
	...
	$sql = "INSERT INTO orders (`item_id`, `user_id`, `qty`, `table`, `created_at`, `order_key`) VALUES ('".$data[$m_items][$i]."','".$user_id['user_id']."','".$data[$m_qty][$i]."','".$tbl_name."','".$data['dates']."','".$data['order_key']."')";
 echo $sql;
die();
