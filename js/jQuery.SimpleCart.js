...
<input type='hidden' data-name='' name='name[]'/><input type='hidden'data-name='' name='price[]' data-price=''/><input type='hidden'name='count[]'/><button type='submit' id='checkout' class='btn btn-primary'>Proceed To Checkout</button>\n\
</form>\n\
</div>\n\
</div>");
        },
...
<input class='name' name='items[]' value='"+ cartArray[i].name + "'>" + "\
...
<div class='quantity-am'><i class='fa fa-dollar'>" + cartArray[i].price + "</i></div>\n\
    ...
    $.fn.simpleCart = function (options) {
        return this.each(function () {
            var data =  $.data(this, "simpleCart", new simpleCart(this));
