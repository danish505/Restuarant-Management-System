        ...
        <?php $i++; ?>
                    <tr class="c-table__row">
                         <td class="c-table__cell">
                            <img src="img/<?= $dat['image'];?>" width="120"/>
                        </td>
                        <td class="c-table__cell">
...
<option value="<?= $item['id'];?>" <?php if($item['id'] == $dat['item_id']){ echo "selected";}?>>
                        ...
                        <!-- <td class="c-table__cell">
                            <div class="item-price">
                               <input type="text" class="c-input" type="number" name="price[]" value="<?= $dat['price'];?>"/>
                            </div>
                        </td> -->
...
$(document).ready(function(){  
     ...
     $('#add_field_button').click(function(){
        i++;  
       $('.cart-table .c-table tbody').append('<tr id="row'+i+'" class="c-table__row"><td class="c-table__cell"> <div class="c-field u-mb-medium"><label class="c-field__label" for="'+i+'">Items</label><select class="select_style" name="items[]" id="'+i+'">'+menu_num+'</select></div></td><td class="c-table__cell"><div class="c-field"><input class="c-input" id="input1" type="number" min="0" placeholder="QTY"></div></td><td class="c-table__cell"><div class="item-price"><h6><span>Rs.</span> 650</h6></div></td><td class="c-table__cell"><div class="action-btn"><a id="'+i+'" class="btn_remove c-btn c-btn--danger u-text-xsmall" id="remove_field" href="#">-</a></div></td></tr>')
       });
